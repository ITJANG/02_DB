...
INSERT INTO MEMBER VALUES('MEM01', '123ABC', '홍길동', 
													'991214-1234567', DEFAULT);										

-- INSERT / UPDATE 시 컬럼값으로 DEFAULT 작성하면
-- 테이블 생성 시 해당 컬럼에 지정된 DEFAULT 값으로 삽입
...
-- DEFAULT 설정된 컬럼이라고 삽입/수정 시 DEFAULT만 작성해야하는것 아님
-- 컬럼 데이터타입에 맞춘 데이터 삽입 수정 가능


-- 가입일 -> INSERT시 미작성 하는 경우 DEFAULT 값이 반영되는지 확인
...
--> 전화번호, 주민등록번호처럼 되어있는 데이터라도
-- 0으로 시작될 가능성이 있으면 CHAR, VARCHAR2 같은 문자열타입으로 사용
...
INSERT INTO USER_USED_UQ VALUES (
1, 'USER01', 'PASS01', '홍길동', '남자', 
'010-1234-5678', 'hong_gd@or.kr');
...
INSERT INTO USER_USED_UQ2 VALUES (
1, 'USER01', 'PASS01', '홍길동', '남자', 
'010-1234-5678', 'hong_gd@or.kr');
...
CREATE TABLE USER_USED_PK(
	USER_NO NUMBER CONSTRAINT USER_NO_PK PRIMARY KEY, -- 컬럼레벨(제약조건 작성)
	USER_ID VARCHAR2(20), 
	USER_PWD VARCHAR2(20),
	USER_NAME VARCHAR2(30),
	GENDER VARCHAR2(10),
...
INSERT INTO USER_USED_PK VALUES (
1, 'USER03', 'PASS03', '이순신', '남자', 
'010-2222-2222', 'hong_gd@or.kr');
-- ORA-00001: 무결성 제약 조건(KH.USER_NO_PK)에 위배됩니다
--> 기본키 중복 오류

INSERT INTO USER_USED_PK VALUES (
NULL, 'USER03', 'PASS03', '이순신', '남자', 
'010-2222-2222', 'hong_gd@or.kr');
-- ORA-01400: NULL을 ("KH"."USER_USED_PK"."USER_NO") 안에 삽입할 수 없습니다
--> 기본키 NULL 이므로 오류

INSERT INTO USER_USED_PK VALUES (
2, 'USER02', 'PASS03', '이순신', '남자', 
'010-2222-2222', 'hong_gd@or.kr');
...
1, 'USER01', 'PASS01', '홍길동', '남자', 
'010-1234-5678', 'hong_gd@or.kr');	
--무결성 제약 조건(KH.PK_USERNO_USERID)에 위배됩니다
...
-- USER_GTRDAR(부모/참조테이블)에 10 이라는
-- GRADE_CODE가 존재하므로 가능

INSERT INTO USER_USED_FK VALUES (
2, 'USER02', 'PASS02', '이순신', '남자', 
'010-2133-1231', 'LEE_gd@or.kr', 10);


INSERT INTO USER_USED_FK VALUES (
3, 'USER03', 'PASS03', '유관순', '여자', 
'010-3333-1111', 'yoo_ks@or.kr', 10);

INSERT INTO USER_USED_FK VALUES (
4, 'USER04', 'PASS04', '안중근', '남자', 
'010-3333-1214', 'ahn_jk@or.kr', NULL);
--> NULL 사용 가능
...
-- 부모테이블인 USER_GRADE3에서 GRADE_CODE = 10삭지
